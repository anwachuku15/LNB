...
import { AntDesign, Ionicons, FontAwesome, Fontisto, MaterialIcons, Feather } from '@expo/vector-icons'
    ...
    return (
        <SafeAreaView style={styles.screen}>
            <View style={{flex:1, justifyContent: 'center', alignItems:'center'}}>
                <Text style={{color:Colors.socialdark}}>In-App Marketplace Coming Soon</Text>
                {/* <Fontisto 
                    name='shopping-barcode' 
                    size={40} 
