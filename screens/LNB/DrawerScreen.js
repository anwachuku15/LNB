      ...
      <View style={styles.container}>
        <View style={styles.top}>
          ...
          <View>
            ...
            >
              <Text
                style={{ ...styles.viewProfile, ...{ color: Colors.blue } }}
              >
                View Profile
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                style={{ ...styles.editProfile, ...{ color: Colors.green } }}
              >
        ...
        <ScrollView>
          ...
          >
            <View>
              ...
              />
              <Text style={{ ...styles.text, ...{ color: Colors.socialdark } }}>
                {" "}
                Trending{" "}
              </Text>
            </View>
          ...
          {admin && (
            ...
            >
              <View>
                ...
                />
                <Text
                  style={{ ...styles.text, ...{ color: Colors.redcrayola } }}
                >
                  {" "}
                  Admin{" "}
                </Text>
