...
const CreateBioScreen = props => {
    ...
    const headline = props.navigation.getParam('headline')
    const profilePic = props.navigation.getParam('profilePic')
    const finishProfile = async () => {
        const uri = profilePic
        await dispatch(createProfile(uri, headline, bio))
        props.navigation.navigate('App')
    }
            ...
            <View style={{...styles.screen, backgroundColor: background}}>
                <View style={styles.authContainer}>
                    {/* <ScrollView> */}
                        ...
                        <Text style={{alignSelf: 'center', fontWeight: 'bold', color: text, fontSize: 20}}>Tell us about yourself</Text>
                        <Text style={{alignSelf: 'center', textAlign: 'center', color: Colors.placeholder, marginTop: 15, marginBottom: 30}}>Let us know who you are and what you're all about!</Text>
                ...
                <View style={{
                        ...
                        opacity: (bio.length < 2 || bio.length > 150) ? 0.4 : 1
                }}>
                    <TouchableCmp 
                        disabled={bio.length < 2 || bio.length > 150}
