    ...
    pinned && (
      ...
      >
        <TouchableCmp
          ...
          onPress={() => navToPostDetail(pinned.id)}
        >
          <View
            style={{
              ...styles.feedItem,
          ...
          >
            {pinned && (
              ...
              >
                <AntDesign
                  name="pushpino"
                  color={
                    scheme === "dark" ? Colors.disabled : Colors.placeholder
                  }
                  size={14}
                  style={{ marginRight: 6 }}
                />
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              >
                <Image
                  source={{ uri: pinned.userImage, cache: "force-cache" }}
                  style={styles.avatar}
                />
              </TouchableCmp>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  <View>
                    <TouchableCmp
                      onPress={() =>
                        selectUserHandler(pinned.uid, pinned.userName)
                      }
                    >
                      <Text style={{ ...styles.name, ...{ color: text } }}>
                        ...
                        <Text style={styles.timestamp}>
                          {" "}
                          · {moment(pinned.timestamp).fromNow()}
                        </Text>
                      </Text>
                    </TouchableCmp>
                  </View>
                    ...
                    <View style={styles.modalView}>
                      <View
                        style={{
                          ...styles.modal,
                          backgroundColor:
                            scheme === "dark" ? Colors.darkModal : "white",
                        }}
                      >
                        <View
                          style={{
                ...
                >
                  <Text style={{ ...styles.post, ...{ color: text } }}>
                    {pinned.body}
                  </Text>
                </Hyperlink>
                {pinned.imageUrl ? (
                ...
                {showNeedActions && pinned.id && (
                  <NeedActions
                    needId={pinned.id}
                    leaveComment={() =>
                      commentButtonHandler(pinned.id, pinned.userName)
                    }
                  />
                )}
              </View>
