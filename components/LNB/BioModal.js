                ...
                <View style={styles.modalView}>
                    <View style={{...styles.modal, backgroundColor: scheme==='dark' ? Colors.darkModal : 'white'}}>
                        ...
                        <View style={{margin: 10, alignItems: 'center'}}>
                            <Text style={{color:Colors.primary, fontSize: 24, fontFamily: 'poppinsBold'}}>{user.displayName}</Text>
                            <Text style={{color:Colors.green, fontSize: 18, fontFamily: 'poppins'}}>About me</Text>
                            <Text style={{color:text, fontSize: 16, marginBottom: 10, textAlign:'center'}}>{user.bio}</Text>
                            
                            <Text style={{color:Colors.green, fontSize: 18, fontFamily: 'poppins'}}>Contact</Text>
                            <TouchableCmp
                                onPress={async () => {
                                ...
                                style={{backgroundColor:Colors.blue, borderRadius: 5, paddingHorizontal: 10, paddingVertical: 5}}
                            >
