...
import { FontAwesome, FontAwesome5, Feather, AntDesign, MaterialCommunityIcons, MaterialIcons} from '@expo/vector-icons'
    ...
    return (
        <TouchableWithoutFeedback onPress={toggleCreateMenu}>
            <View style={styles.button}>
                <Animated.View style={{position: 'absolute', left: announcementX, top: announcementY}}>
                    <View style={{...styles.secondaryButton, backgroundColor: Colors.redcrayola}}>
                ...
                <Animated.View style={{position: 'absolute', left: needX, top: needY}}>
                ...
                <Animated.View style={[{...styles.createButton, backgroundColor: createButtonColor, borderColor: Colors.primary, borderWidth: 2}, createButtonStyle]}>
